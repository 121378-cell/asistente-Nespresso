    ...
    describe('Repairs API', () => {
        describe('getAllRepairs', () => {
            it('should fetch all repairs', async () => {
                const mockRepairs = [
                    { id: '1', name: 'Repair 1', machineModel: 'Gemini CS2', serialNumber: 'SN123', timestamp: Date.now(), messages: [] },
                    { id: '2', name: 'Repair 2', machineModel: 'Momento 200', serialNumber: 'SN456', timestamp: Date.now(), messages: [] }
                ];
        ...
        describe('createRepair', () => {
            ...
            it('should handle validation errors', async () => {
                ...
                await expect(apiService.createRepair({
                    name: '',
                    machineModel: null,
                    serialNumber: null,
                    messages: [],
        ...
        describe('updateRepair', () => {
            ...
            it('should handle update errors', async () => {
                ...
                await expect(apiService.updateRepair('999', { name: 'New Name' }))
    ...
    describe('Analytics API', () => {
        ...
        describe('runPredefinedQuery', () => {
            ...
            it('should handle invalid query types', async () => {
                ...
                await expect(apiService.runPredefinedQuery('invalid_query'))
