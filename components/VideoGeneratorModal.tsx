...
const VideoGeneratorModal: React.FC<VideoGeneratorModalProps> = ({ onClose }) => {
      ...
      return (
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Para usar la generación de vídeo, necesitas seleccionar una API Key de tu proyecto. El
            uso de esta función puede incurrir en costes. Consulta la{' '}
            <a
          ...
          <button
            onClick={onClose}
            className="mt-2 w-full bg-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-300"
          >
            Cancelar
          </button>
        </div>
      ...
      return (
        <div className="text-center p-6">
          ...
          <a
            ...
            className="mt-4 inline-block px-6 py-2 bg-blue-500 text-white font-semibold rounded-full hover:bg-blue-600"
          >
            Descargar Vídeo
          </a>
          <button
            onClick={() => setGeneratedVideoUrl(null)}
            className="mt-4 ml-2 inline-block px-6 py-2 bg-gray-200 text-gray-700 font-semibold rounded-full hover:bg-gray-300"
          >
            Crear otro
          </button>
        </div>
      ...
      <div className="p-6">
        ...
        <nav className="mb-6 p-3 bg-gray-50 border border-gray-200 rounded-md">
          ...
          <ul className="flex flex-col md:flex-row md:justify-around space-y-1 md:space-y-0 text-sm">
            <li>
              <a href="#video-image-upload" className="text-blue-600 hover:underline">
                1. Subir imagen
              </a>
            </li>
            <li>
              <a href="#video-prompt-description" className="text-blue-600 hover:underline">
                2. Descripción del vídeo
              </a>
            </li>
            <li>
              <a href="#video-aspect-ratio" className="text-blue-600 hover:underline">
        ...
        <form onSubmit={handleSubmit}>
            ...
            >
              <div className="space-y-1 text-center">
                ...
                <div className="flex text-sm text-gray-600">
                  <p className="pl-1">
                    {imageFile ? `Archivo: ${imageFile.name}` : 'Haz clic para subir un archivo'}
                  </p>
                </div>
          ...
          <div id="video-prompt-description" className="mb-4 pt-2">
            <label htmlFor="prompt" className="block text-sm font-medium text-gray-700">
              2. Describe qué quieres que pase en el vídeo
            </label>
            <textarea
              id="prompt"
              value={prompt}
              ...
              placeholder="Ej: un coche futurista aparece y se va volando"
            ></textarea>
          </div>

          <div id="video-aspect-ratio" className="mb-6 pt-2">
            <label className="block text-sm font-medium text-gray-700">
              3. Elige la orientación
            </label>
            <div className="mt-2 flex gap-4">
              <label
                className={`flex-1 p-3 border rounded-md cursor-pointer text-center ${aspectRatio === '16:9' ? 'border-blue-500 ring-2 ring-blue-500' : 'border-gray-300'}`}
              >
                <input
                  type="radio"
                  name="aspectRatio"
              ...
              <label
                className={`flex-1 p-3 border rounded-md cursor-pointer text-center ${aspectRatio === '9:16' ? 'border-blue-500 ring-2 ring-blue-500' : 'border-gray-300'}`}
              >
                <input
                  type="radio"
                  name="aspectRatio"
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white rounded-lg shadow-2xl w-full max-w-lg relative max-h-[90vh] overflow-y-auto scroll-smooth"
