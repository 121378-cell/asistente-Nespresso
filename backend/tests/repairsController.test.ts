...
const { mockFindMany, mockFindUnique, mockCreate, mockUpdate, mockDelete, mockDisconnect } = vi.hoisted(() => ({
    mockFindMany: vi.fn(),
...
import { getAllRepairs, getRepairById, createRepair, updateRepair, deleteRepair } from '../src/controllers/repairsController.js';
...
class PrismaClientKnownRequestError extends Error {
    ...
    constructor(message: string, code: string, clientVersion: string = '5.0.0', meta?: Record<string, any>) {
        super(message);
